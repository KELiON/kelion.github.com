...
mejs.HtmlMediaElementShim = {
    ...
    determinePlayback: function (a, b, c, d, e) {
        ...
        if (c && (b.mode === "auto" || b.mode === "native")) {
            ...
            for (f = 0; f < g.length; f++) if ((a.canPlayType(g[f].type).replace(/no/, "") !== "" || a.canPlayType(g[f].type.replace(/mp3/, "mpeg")).replace(/no/, "") !== "") && !(b.webkitFlash && mejs.MediaFeatures.isChrome)) {
                h.method = "native";
                h.url = g[f].url;
                break
            }
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        setControlsSize: function () {
            ...
            if (c === 0 || !c) {
                ...
                c = this.controls.width() - a - parseInt(b.css('paddingLeft')) - parseInt(b.css('paddingRight')) - 10;
            }
            b.width(c);
...
(function (f) {
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        renderContextMenu: function (a, c) {
            for (var b = this, d = "", e = b.options.contextMenuItems, g = 0, k = e.length; g < k; g++) if (e[g].isSeparator) d += '<div class="mejs-contextmenu-separator"></div>';
            else {
                var h = e[g].render(b);
